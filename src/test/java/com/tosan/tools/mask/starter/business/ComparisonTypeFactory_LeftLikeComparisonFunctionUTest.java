 ...
 * @since 9/19/2022
 */
public class ComparisonTypeFactory_LeftLikeComparisonFunctionUTest {
    private ComparisonTypeFactory.ComparisonFunction function = new ComparisonTypeFactory.
            LeftLikeComparisonFunction();
    ...
    public void testGetComparisonType_returnEqualsIgnoreCaseType() {
        assertEquals(ComparisonType.LEFT_LIKE, function.getComparisonType());
    }
}